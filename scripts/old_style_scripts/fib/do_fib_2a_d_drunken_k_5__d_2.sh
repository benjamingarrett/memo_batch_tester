# 10/31/20 01:015
# 2a d-drunken k=5, d=2, 1 <= n <= 42626 and 1000000 <= n <= 1040000 and 1000000000 <= n <= 1000040000
version=2a
nru_k=5
nru_a=0.224609
nru_d=2
...
max_size=42626
while [ $m -le $max_size ] ; do
  python3 fib.py 1 5 $m $version solve_once $folder $strategy $nru_k $nru_a $nru_d
  m=$(( m+1 ))
done
sleep 3
