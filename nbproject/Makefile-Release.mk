...
${OBJECTDIR}/_ext/c56916c5/MurmurHash32.o: ../hashing/MurmurHash32.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c56916c5/MurmurHash32.o ../hashing/MurmurHash32.c

${OBJECTDIR}/_ext/c56916c5/MurmurHash64A.o: ../hashing/MurmurHash64A.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/c56916c5
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c56916c5/MurmurHash64A.o ../hashing/MurmurHash64A.c

${OBJECTDIR}/_ext/554cfc1b/memo.o: ../memoization/memo.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/554cfc1b
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/554cfc1b/memo.o ../memoization/memo.c

${OBJECTDIR}/_ext/554cfc1b/memo_long_int.o: ../memoization/memo_long_int.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/554cfc1b
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/554cfc1b/memo_long_int.o ../memoization/memo_long_int.c
...
${OBJECTDIR}/_ext/f34e89a/operation_sequence_reader.o: ../operation_sequence_reader/operation_sequence_reader.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89a/operation_sequence_reader.o ../operation_sequence_reader/operation_sequence_reader.c

${OBJECTDIR}/_ext/f34e89b/lcss.o: ../lcss100/lcss.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89b
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89b/lcss.o ../lcss100/lcss.c

${OBJECTDIR}/_ext/f34e89c/edit_distance.o: ../edit_distance100/edit_distance.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89c/edit_distance.o ../edit_distance100/edit_distance.c

${OBJECTDIR}/_ext/f34e89d/kmp.o: ../kmp100/kmp.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89d/kmp.o ../kmp100/kmp.c

${OBJECTDIR}/_ext/f34e89e/fibonacci.o: ../fibonacci100/fibonacci.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89e
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89e/fibonacci.o ../fibonacci100/fibonacci.c

${OBJECTDIR}/_ext/f34e89f/lcs_instance_reader.o: ../lcs_instance_reader/lcs_instance_reader.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89f
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89f/lcs_instance_reader.o ../lcs_instance_reader/lcs_instance_reader.c

${OBJECTDIR}/_ext/f34e89g/permutations.o: ../permutations100/permutations.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89g
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89g/permutations.o ../permutations100/permutations.c

${OBJECTDIR}/_ext/f34e89h/sequence_alignment.o: ../sequence_alignment100/sequence_alignment.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89h
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89h/sequence_alignment.o ../sequence_alignment100/sequence_alignment.c

${OBJECTDIR}/_ext/f34e89i/generate.o: ../lcss_instance_generator/generate.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89i
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89i/generate.o ../lcss_instance_generator/generate.c

${OBJECTDIR}/_ext/f34e89j/random.o: ../random/random.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f34e89j
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f34e89j/random.o ../random/random.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/memo_batch_test.o: memo_batch_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -O3 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/memo_batch_test.o memo_batch_test.c
